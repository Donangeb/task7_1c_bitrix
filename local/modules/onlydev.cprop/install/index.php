...
class onlydev_cprop extends CModule
{
    var $MODULE_ID  = 'onlydev.cprop';
    ...
    function __construct()
    {
        ...
        $this->MODULE_ID = 'onlydev.cprop';
        $this->MODULE_VERSION = $arModuleVersion['VERSION'];
        $this->MODULE_VERSION_DATE = $arModuleVersion['VERSION_DATE'];
        $this->MODULE_NAME = GetMessage('IEX_CPROP_MODULE_NAME');
        $this->MODULE_DESCRIPTION = GetMessage('IEX_CPROP_MODULE_DESC');

        $this->PARTNER_NAME = GetMessage('IEX_CPROP_PARTNER_NAME');
